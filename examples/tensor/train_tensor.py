...
from vanilla_tt_llama import VanillaTTLlamaForTraining
...
if __name__ == "__main__":
    ...
    trainer = DistributedTrainer(config, model_config_class=TTLlamaConfig, model_class=VanillaTTLlamaForTraining)
